...
module "this" {
  ...
  source                      = "https://github.com/PiotrKuligowski/terraform-aws-spot-asg.git"
  ami_id                      = var.ami_id
  ...
  attach_security_groups      = var.attach_security_groups
...
locals {
  ebs_id = var.ebs_id == null ? aws_ebs_volume.this.id : var.ebs_id
